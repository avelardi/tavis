...
#   feeds = relationship('Vuln_Feed',secondary=link_vuln_link_feed_table,back_populates='links')
#
...
#   description = Column(Text)
#   vendor = Column(Integer,ForeignKey('cpe_vendor.id'))
#   links = relationship('Vuln_Link',secondary=link_vuln_link_feed_table,back_populates='feeds')
#
#
...
class CPE_Vendor(Base):
  ...
  products = relationship('CPE_Product')
  name = Column(String)
  site = Column(String)
  info = Column(Text)
